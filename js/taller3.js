...
$("#tabas").append('<tr><td align="center" style="dislay:none">Nombre</td>'+
 	'<td align="center" style="dislay:none;">City</td>' + 
 	'<td align="center" style="dislay:none;">Country</td>');
    for (i = 0; i < DatosJson.ciudades.length; i++){
 
 $("#tabas").append('<tr>' + 
 	'<td align="center" style="dislay: none;">' + DatosJson.ciudades[i].Name + '</td>'+
 	'<td align="center" style="dislay: none;">' + DatosJson.ciudades[i].City + '</td>'+
 	'<td align="center" style="dislay: none;">' + DatosJson.ciudades[i].Country + '</td>'+'</tr>');
    }
}
